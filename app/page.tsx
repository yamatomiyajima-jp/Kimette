...
export default function Home() {
  return (
    <div className="flex flex-col min-h-dvh">
      {/* Hero */}
      <section className="flex flex-col items-center justify-center px-6 pt-16 pb-12 bg-gradient-to-b from-white to-bg-secondary">
        ...
        <p className="mt-2 text-base text-text-secondary text-center max-w-xs leading-relaxed">
          チップを配分して、みんなで決めよう
        </p>
